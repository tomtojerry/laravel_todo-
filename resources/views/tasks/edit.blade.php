...
<body>
    ...
    <form action="{{ route('tasks.update', ['id' => $task->id]) }}" class="form" method="POST">
        @csrf
        ...
        <div class="form-group">
            ...
            <textarea name="content" id="content" rows="5" placeholder="タスク内容を具体的に書きましょう">{{ old('content', $task->content) }}</textarea>
        </div>
